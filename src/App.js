        ...
        <Route exact path='/' render={() => (
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <BookShelf title="Currently Reading" books={this.state.books.filter((book) => book.status === "Currently Reading")}/>
                <BookShelf title="Want to Read" books={this.state.books.filter((book) => book.status === "Want to Read")}/>
                <BookShelf title="Read" books={this.state.books.filter((book) => book.status === "Read")}/>
              </div>
            </div>
